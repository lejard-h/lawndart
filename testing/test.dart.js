...
$dynamic("indexOf").CanvasPixelArray = function(element, start) {
  return dom__Lists.indexOf(this, element, start, this.length);
}
...
$dynamic("getRange").CanvasPixelArray = function(start, length) {
  return dom__Lists.getRange(this, start, length, []);
}
...
$dynamic("indexOf").HTMLCollection = function(element, start) {
  return dom__Lists.indexOf(this, element, start, this.get$length());
}
...
// ********** Code for dom__Lists **************
function dom__Lists() {}
dom__Lists.indexOf = function(a, element, startIndex, endIndex) {
...
dom__Lists.getRange = function(a, start, length, accumulator) {
  if (length < (0)) $throw(new IllegalArgumentException("length"));
...
//  ********** Library lawndart **************
// ********** Code for LocalStorageAdapter **************
function LocalStorageAdapter(options) {
  this.storage = html_get$$window().localStorage;
}
LocalStorageAdapter.prototype.get$_allKeys = function() {
  return json_JSON.parse(this.storage.getItem("__lawndart__keys"));
}
LocalStorageAdapter.prototype.open = function() {
  return FutureImpl.FutureImpl$immediate$factory(true);
}
LocalStorageAdapter.prototype.save = function(obj, key) {
  key = $eq$(key) ? _uuid() : key;
  this.storage.setItem(key, json_JSON.stringify(obj));
  return _results(key);
}
LocalStorageAdapter.prototype.batch = function(objs, _keys) {
  var newKeys = [];
  for (var i = (0);
   $lt$(i, objs.get$length()); i = $add$(i, (1))) {
    var key = _keys.$index(i);
    key = $eq$(key) ? _uuid() : key;
    this.storage.setItem(key, json_JSON.stringify(objs.$index(i)));
  }
  return _results(newKeys);
}
LocalStorageAdapter.prototype.getByKey = function(key) {
  return _results(this.storage.getItem(key));
}
LocalStorageAdapter.prototype.getByKeys = function(_keys) {
  var $this = this; // closure support
  var values = _keys.map$1((function (key) {
    return $this.storage.getItem(key);
  })
  );
  return _results(values);
}
LocalStorageAdapter.prototype.all = function() {
  var $this = this; // closure support
  var values = this.get$_allKeys().map$1((function (key) {
    return $this.storage.getItem(key);
  })
  );
  return _results(values);
}
LocalStorageAdapter.prototype.removeByKey = function(key) {
  var _keys = this.get$_allKeys();
  _keys.removeRange(_keys.indexOf$1(key), (1));
  this.storage.removeItem(key);
  this.storage.setItem("__lawndart__keys", json_JSON.stringify(_keys));
  return _results(true);
}
LocalStorageAdapter.prototype.removeByKeys = function(_keys) {
  var $this = this; // closure support
...
LocalStorageAdapter.prototype.nuke = function() {
  this.storage.removeItem("__lawndart__keys");
  this.storage.clear();
  return _results(true);
}
LocalStorageAdapter.prototype.open$0 = LocalStorageAdapter.prototype.open;
LocalStorageAdapter.prototype.save$2 = LocalStorageAdapter.prototype.save;
// ********** Code for top level **************
function _uuid() {
  $throw(new NotImplementedException());
}
function _results(obj) {
  return FutureImpl.FutureImpl$immediate$factory(obj);
}
//  ********** Library test **************
// ********** Code for top level **************
function p(msg) {
  ...
  var li = _ElementFactoryProvider.Element$tag$factory("li");
  li.set$text(msg);
...
(function(){
  ...
  var table = [
    ...
    , ['HTMLCollection', 'HTMLCollection|HTMLOptionsCollection']
    , ['HTMLElement', [v5/*HTMLHtmlElement*/,v6/*HTMLMediaElement*/,'HTMLElement|HTMLAnchorElement|HTMLAppletElement|HTMLAreaElement|HTMLBRElement|HTMLBaseElement|HTMLBaseFontElement|HTMLBodyElement|HTMLButtonElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDetailsElement|HTMLDirectoryElement|HTMLDivElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFontElement|HTMLFormElement|HTMLFrameElement|HTMLFrameSetElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLIFrameElement|HTMLImageElement|HTMLInputElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLSelectElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement'].join('|')]
...
var const$0004 = Object.create(NotImplementedException.prototype, {});
var $globals = {};
$static_init();
main();
